...
Item {
    ...
    property int indexMonth: {
        if(month.visible){
            ...
            month_yo.currentIndex = month.currentIndex
            month_yo_dark.currentIndex = month.currentIndex
        ...
        if(month_fr.visible){
            ...
            month_yo.currentIndex = month_fr.currentIndex
            month_yo_dark.currentIndex = month_fr.currentIndex
            return month_fr.currentIndex
        }
        if(month_yo.visible){
            month.currentIndex = month_yo.currentIndex
            month_dark.currentIndex = month_yo.currentIndex
            month_fr.currentIndex = month_yo.currentIndex
            month_fr_dark.currentIndex = month_yo.currentIndex
            month_yo_dark.currentIndex = month_yo.currentIndex
            return month_yo.currentIndex
        }
        ...
        if(month_fr_dark.visible){
            month.currentIndex = month_fr_dark.currentIndex
            month_dark.currentIndex = month_fr_dark.currentIndex
            month_fr.currentIndex = month_fr_dark.currentIndex
            month_yo.currentIndex = month_fr_dark.currentIndex
            month_yo_dark.currentIndex = month_fr_dark.currentIndex
            return month_fr_dark.currentIndex
        }
        if(month_yo_dark.visible){
            month.currentIndex = month_yo_dark.currentIndex
            month_dark.currentIndex = month_yo_dark.currentIndex
            month_fr.currentIndex = month_yo_dark.currentIndex
            month_fr_dark.currentIndex = month_yo_dark.currentIndex
            month_yo.currentIndex = month_yo_dark.currentIndex
            return month_yo_dark.currentIndex
        }
